...
const SERVER_MEETING_PROVIDERS = { 'microsoft-teams': 'microsoft', 'google-meet': 'google', 'zoom': 'zoom', 'webex': 'webex' };
...
window.addEventListener('message', (e) => {
    ...
    const NAMES = { 'microsoft-teams': 'Microsoft Teams', 'google-meet': 'Google Meet', 'zoom': 'Zoom', 'webex': 'Cisco Webex' };
...
async function handleStartMeeting(event) {
    ...
    let clientName = document.getElementById('meetingClientName').value || 'Client';
    let clientEmail = document.getElementById('meetingClientEmail').value || 'blue2027astra@tutamail.com';
